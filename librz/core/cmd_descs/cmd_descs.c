...
static const RzCmdDescArg rzil_vm_step_till_addr_args[] = {
	{
		.name = "address",
		.type = RZ_CMD_ARG_TYPE_RZNUM,
		.flags = RZ_CMD_ARG_FLAG_LAST,
...
static const RzCmdDescHelp rzil_vm_step_till_addr_help = {
	.summary = "Step till PC equals address within the RzIL VM",
	.args = rzil_vm_step_till_addr_args,
};
...
RZ_IPI void rzshell_cmddescs_init(RzCore *core) {
	...
	RzCmdDesc *rzil_vm_step_till_addr_cd = rz_cmd_desc_argv_new(core->rcmd, aez_cd, "aezst", rz_rzil_vm_step_till_addr_handler, &rzil_vm_step_till_addr_help);
	rz_warn_if_fail(rzil_vm_step_till_addr_cd);
